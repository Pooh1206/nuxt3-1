...
<div class="flex diygw-col-24 diygw-bottom">
    <div class="diygw-grid diygw-actions">
        <button class="diygw-action">
            <div class="diygw-grid-inner">
                <div class="diygw-grid-icon diygw-avatar" style="">
                    <NuxtLink to="/">
                    <img mode="aspectFit" class="diygw-avatar-img" src="/img/1-001.png" />
                    </NuxtLink>
                </div>
        ...
        <button class="diygw-action" style="background-color: rgba(255, 255, 255, 0) !important">
            <div class="diygw-grid-inner">
                <div class="diygw-grid-icon diygw-avatar" style="">
                    <img mode="aspectFit" class="diygw-avatar-img" src="/img/2-001.png" />
                </div>
        ...
        <button class="diygw-action">
            <div class="diygw-grid-inner">
                <div class="diygw-grid-icon diygw-avatar" style="">
                    ...
                    <img mode="aspectFit" class="diygw-avatar-img" src="/img/chat3.png" />
                </div>
        ...
        <button class="diygw-action">
            <div class="diygw-grid-inner">
                <div class="diygw-grid-icon diygw-avatar" style="">
                    <img mode="aspectFit" class="diygw-avatar-img" src="/img/4-001.png" />
                </div>
